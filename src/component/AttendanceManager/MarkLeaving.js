    ...
    return (
        <div className="justify-content-center">
            ...
            <Row className="d-flex justify-content-center mt-3 bg-warning text-white">
                    ...
                    <Col s lg="2" className="d-flex justify-content-center align-items-center py-2"><h6 className="text-center">Time: {arrivingTime} </h6></Col>
            ...
            <Row className="justify-content-center mt-2 ">
                <div className="arrivingSearchResults border pl-5 py-3">
                    ...
                    <Col xs lg="4"><span className={(employee.arriveAt!="null")? `MarkArriving__hide` :`MarkArriving__displaywarning` }>
                        haven't arrived to work yet </span></Col>

                    <Col xs lg="2">

                        <Button variant="contained" color="primary" 
                                disabled={(employee.leftAt=="null" && employee.arriveAt!="null")? false : true}
                        ...
                        <Button variant="contained" color="primary" 
                                disabled={(employee.leftAt!="null")? false : true}
